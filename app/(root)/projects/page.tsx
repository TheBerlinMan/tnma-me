      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="font-light max-w-prose text-gray-500">
            A collection of creative and technical projects spanning art, design,
            and research, consisting of a variety of different mediums and
            materials.
          </div>
        </div>
            ...
            <table className="border-collapse">
              <tbody>
                ...
                <tr className="h-8">
                  ...
                  <td className="pr-8 text-left">
                    <Link href="/projects/bluebook" className="">
                      Blue Book
                    </Link>
                  </td>
